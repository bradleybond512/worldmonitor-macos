...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  intelligence: {
    ...
    panelKeys: ['watchlist', 'saved-places', 'local-logistics', 'comms-plan', 'unified-alert-inbox', 'alert-center', 'strategic-risk', 'cii', 'geo-hubs', 'intel', 'gdelt-intel', 'cascade', 'telegram-intel'],
    variants: ['full'],
  },
  regionalNews: {
